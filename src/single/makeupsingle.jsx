...
import { makeup } from "../stores/data/makeupdata"; // Ensure this file contains the makeup product data
...
const MakeupSingle = () => {
  ...
  console.log("cartContext:", { addToCart, cartItems }); // Debugging the cart context

  const product = makeup.find((item) => item.id === id);
