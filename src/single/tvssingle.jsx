...
import { tvs } from "../stores/data/tv";
...
const TVSingle = () => {
  ...
  console.log("cartContext:", { addToCart, cartItems }); // Debug
  console.log("tvs data:", tvs); // Debug
    ...
    <>
      ...
      <div className="ind-page">
        ...
        <div className="ind-data space">
          ...
          <div className="ind-exist pad">{product.availability}</div>
